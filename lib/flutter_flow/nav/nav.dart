...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const NavBarPage() : const LogoInterfaceWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: 'LogoInterface',
          path: '/logoInterface',
          builder: (context, params) => const LogoInterfaceWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: 'inviocePage',
          path: '/inviocePage',
          builder: (context, params) => const InviocePageWidget(),
        ),
        FFRoute(
          name: 'AddingAClient',
          path: '/addingAClient',
          builder: (context, params) => const AddingAClientWidget(),
        ),
        FFRoute(
          name: 'depositPage',
          path: '/depositPage',
        ...
        FFRoute(
          name: 'chooseWayToDeposit',
          path: '/chooseWayToDeposit',
          builder: (context, params) => const ChooseWayToDepositWidget(),
        ),
        FFRoute(
          name: 'barcodePage',
          path: '/barcodePage',
          builder: (context, params) => const BarcodePageWidget(),
        ),
        FFRoute(
          name: 'depositComplete',
          path: '/depositComplete',
          builder: (context, params) => const DepositCompleteWidget(),
        ),
        FFRoute(
          name: 'withdrawalPage',
          path: '/withdrawalPage',
          builder: (context, params) => const WithdrawalPageWidget(),
        ),
        FFRoute(
          name: 'chooseWayToWithdrawal',
          path: '/chooseWayToWithdrawal',
          builder: (context, params) => const ChooseWayToWithdrawalWidget(),
        ),
        FFRoute(
          name: 'barcodePageToWithdrawal',
          path: '/barcodePageToWithdrawal',
          builder: (context, params) => const BarcodePageToWithdrawalWidget(),
        ),
        FFRoute(
          name: 'withdrawalComplete',
          path: '/withdrawalComplete',
          builder: (context, params) => const WithdrawalCompleteWidget(),
        ),
        FFRoute(
