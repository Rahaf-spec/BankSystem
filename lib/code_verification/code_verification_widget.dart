...
class _CodeVerificationWidgetState extends State<CodeVerificationWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0x8261C5B8),
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'l1mwlrba' /* Enter the code number from SMS */,
                                            ),
                                          ...
                                          decoration: InputDecoration(
                                            hintText:
                                                FFLocalizations.of(context)
                                                    .getText(
                                              'nixlrbbw' /* We sent code to phone number *... */,
                                            ),
                                            hintStyle:
